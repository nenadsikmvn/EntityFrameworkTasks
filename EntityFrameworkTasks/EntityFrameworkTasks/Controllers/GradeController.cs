...
namespace EntityFrameworkTasks.Controllers
{
    public class GradeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradeId,StudentId,CourseId,Grade1")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradeId,StudentId,CourseId,Grade1")] Grade grade)
        {
            if (ModelState.IsValid)
            {
